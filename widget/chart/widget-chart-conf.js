...
WAF.addWidget({
    ...
    onCreate : function(tag , param){
        ...
        if(!param._isLoaded) {
            ...
            container.getAttribute('class').setValue(classes.container);
            tag.link(container);
            container.domUpdate();
            ...
            title.getAttribute('class').setValue(classes.title);
            title.savePosition('right', 0)
            ...
            legendary.getAttribute('class').setValue(classes.legendary);
            legendary.getAttribute('data-draggable').setValue(true);
//            legendary._properties.style.text = true;
            legendary.savePosition('right', 15);
            legendary.removeLeftConstraint();
            tag.link(legendary);
            legendary.link(tag);
            legendary.domUpdate();
            ...
            $('#' + tag.getOverlayId()).css('width', '');
            $('#' + tag.getOverlayId()).css('height', '');
            
            tag.setParent(container);
            tag.savePosition('bottom', 6);
            tag.savePosition('right', 190);
            tag.savePosition('top', 80);
            tag.savePosition('left', 6);
