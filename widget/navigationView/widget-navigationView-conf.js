...
WAF.addWidget({
    ...
    onCreate: function ( wid, param ) { 
            ...
            */
            wid.addNewView = function(data) {
                ...
                */
                ...
                view.setXY( 0, 0, true );
                view.getAttribute('class').setValue('waf-navigationView-view waf-navigation-view'+viewIndex);
                ...
                header.getAttribute('class').setValue('waf-widget-header waf-navigationView-header');
                ...
                title.getAttribute('class').setValue('waf-navigationView-title');
                ...
                backButton.getAttribute('class').setValue('waf-navigationView-header-back-button');
                ...
                body.getAttribute('class').setValue('waf-widget-body waf-navigationView-body');
                body.setParent( view );  
            ...
            wid.deleteView = function(data) {
                ...
                //viewID          = widID+'_view'+viewIndexToRm,
        ...
        */
        function createStructure () {
            ...
            content.getAttribute('class').setValue('waf-navigationView-content');
 ...
            content.resizeHandles = 'none';
            ...
            footer.getAttribute('class').setValue('waf-widget-footer waf-navigationView-footer');
