...
if (typeof(WAF) === 'undefined') {
                    ...
                    if (obj.kind) { // check for dataSource
                        switch (obj.kind) {
                            ...
                            case 'login':
                                ...
                                break;
                            case 'combobox':
                                var htmlInput = $('#' + obj.renderId).children('input');
                                switch (event) {
                                    case 'change':
                                        break;
                                    case 'focus':
    ...
    WAF.loader = {
        ...
        detectHtml5Features: function() {
            ...
            i = 0,
            inputEl = document.createElement('input'), // check for special input attributes
