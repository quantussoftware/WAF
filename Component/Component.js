    ...
    if (icomponent && icomponent.cache && icomponent.cache.html && icomponent.cache.style && icomponent.cache.script) {                                       
        ...
        $.ajax({
            ...
            success : function (data) {
                ...
                // get the html            
                $.get(param.path + '/' + data.html + '?tmp=' + tempId, function (html) {
                                            ...
                                            for (sourceName in sources) {
                                                if (sourceName.indexOf(param.id + '_') == 0) {                           
                                                    ...
                                                    if (typeof window[sourceName] !== 'undefined') {                                                    
                                                        ...
                                                        extObject += "    that.sourcesVar.__defineGetter__('" + sourcesVarName + "', function () {\r\n\t";   
                                                        extObject += "       return window['" + sourceName + "'];\r\n\t";
                                                        extObject += "   });\r\n\t";                                                            
                                                        extObject += "   that.sourcesVar.__defineSetter__('" + sourcesVarName + "', function (value) {\r\n\t";                               
