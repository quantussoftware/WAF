        ...
        switch (device.toLowerCase()) {
            case 'apple ipad':
                ...
                if (info.orientation == 'landscape') {
                    bgElement.children('.yui-layout-bd').css('background-position', (marginLeft-303) + 'px ' + (marginTop-260) + 'px');
                } else {
                    bgElement.children('.yui-layout-bd').css('background-position', (marginLeft-182) + 'px ' + (marginTop-240) + 'px');
                }
                break;
